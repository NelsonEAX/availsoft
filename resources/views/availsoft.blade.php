...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="author" content="NelsonEAX">
        <meta name="description" content="">

        <title>AvailSoft</title>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/rev_slider/settings.css">
        <link rel="stylesheet" type="text/css" href="assets/css/rev_slider/layers.css">
        <link rel="stylesheet" type="text/css" href="assets/css/rev_slider/navigation.css">
        <!-- fontawesome css -->
        <link rel="stylesheet" type="text/css" href="assets/css/font-awesome.min.css">
        <!-- ET Lineicon CSS -->
        <link rel="stylesheet" type="text/css" href="assets/css/lineicon.css">
    ...
    <div id="container">
        ...
        <nav id="navbar" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="body.html">AvailSoft</a>
                </div>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="page-scroll" href="body.html">Home</a>
                        </li>
                        <li>
            ...
            <div id="rev_slider_1" class="rev_slider fullscreenbanner" style="display: none;">
                <ul>
                    <li data-transition="curtain-1">
                        <img src="assets/images/slideshow/banner-2.jpg" alt="Slideshow" class="rev-slidebg">
                        <!-- START LAYER 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-1-layer-1"
                             data-x="['right','right','center','center']"
                             data-y="['middle','middle','middle','middle']"
                             data-hoffset="['0','0','0','0']"
                             data-voffset="['-90','-90','-80','-70']"
                             data-fontsize="['70','70','50','24']"
                             ...
                             style="z-index: 5; white-space: nowrap; color: #fff; font-weight: 700; text-transform: uppercase;">Business & Creative
                        </div>
                        <!-- END LAYER 1 -->
                        ...
                        <div class="tp-caption tp-resizeme" id="slide-1-layer-2"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; color: #fff; line-height: 22px; text-align: right;">Curabitur aliquet quam id dui posuere blandit. Praesent sapien massa<br/> convallis a pellentesque nec, egestas non nisi.
                        </div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-resizeme" id="slide-1-layer-3"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; line-height: 22px;"><a href="#" class="btn btn-primary">Discover Me</a>
                        </div>
                    </li>
                    <li data-transition="curtain-1">
                        <img src="assets/images/slideshow/banner-3.jpg" alt="Slideshow" class="rev-slidebg">
                        <!-- START LAYER 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-2-layer-1"
                             ...
                             data-responsive_offset="on"
                             data-elementdelay="0.05"
                             style="z-index: 5; white-space: nowrap; color: #222; font-weight: 700; text-transform: uppercase;">COmplete SOlution Pack
                        </div>
                        <!-- END LAYER 1 -->
                        ...
                        <div class="tp-caption tp-resizeme" id="slide-2-layer-2"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; color: #222; text-align: center;">Curabitur aliquet quam id dui posuere blandit. Praesent sapien massa<br/> convallis a pellentesque nec, egestas non nisi.
                        </div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-resizeme" id="slide-2-layer-3"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; line-height: 22px;"><a href="#" class="btn btn-primary black-border">Buy Template</a>
                        </div>
                    </li>
                    <li data-transition="curtain-1">
                        <img src="assets/images/slideshow/banner-1.jpg" alt="Slideshow" class="rev-slidebg">
                        <!-- START LAYER 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-3-layer-1"
                             ...
                             data-responsive_offset="on"
                             data-elementdelay="0.05"
                             style="z-index: 5; white-space: nowrap; color: #fff; font-weight: 700; text-transform: uppercase;">COmplete SOlution Pack
                        </div>
                        <!-- END LAYER 1 -->
                        ...
                        <div class="tp-caption tp-resizeme" id="slide-3-layer-2"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index: 5; white-space: nowrap; line-height: 22px;"><a href="#" class="btn btn-primary">Buy Template</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <section class="call-to-action">
            <div class="container">
                <div class="row">
                    <h2>Modern And Clead Design <a href="#" class="btn btn-primary white-border">Explore ABout Us</a></h2>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title text-center">
                        <h3>About Us</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo </p>
                    </div>
                </div>
            </div>
                ...
                <div class="inner-feature-box">
                    <div class="feature-post">
                        ...
                        <div class="hover-feature">
                            ...
                            <span></span>
                            <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate sem tristique cursus. Nam nulla quam, gravida non, commodo a, sodales sit amet, nisi. Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis.</p>
                        </div>
                    </div>
                    <div class="feature-post">
                        <div class="feature-post-content">
                            <a href="#"><i class="icon-aperture"></i></a>
                            <h2>GREAT SUPPORT</h2>
                    ...
                    <div class="feature-post">
                        <div class="feature-post-content">
                            ...
                            <h2>RETINA READY</h2>
                            <p>Donec nec justo eget felis facilisis fermentum. sodales sit amet, nisi  </p>
                        </div>
                        <div class="hover-feature">
                    ...
                    <div class="feature-post">
                        <div class="feature-post-content">
                            <a href="#"><i class="icon-document"></i></a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="col-md-6">
                                ...
                                <div class="feature-3">
                                    <a href="#"><i class="icon-layers"></i></a>
                                    <h4>Support</h4>
                                    <span>We support client</span>
                                </div>
                                <div class="feature-3">
                                    <a href="#"><i class="icon-genius"></i></a>
                                    <h4>Genius</h4>
                            ...
                            <div class="col-md-6">
                                <div class="feature-3">
                                    <a href="#"><i class="icon-bargraph"></i></a>
                                    <h4>Economy</h4>
                                    <span>Fast Business Growth</span>
                                </div>
                                <div class="feature-3">
                                    <a href="#"><i class="icon-puzzle"></i></a>
                                    <h4>Up to date</h4>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row animated-counter-section" style="margin-top: 30px;">
                            <div class="col-md-3">
        ...
        <section id="services" class="pad-t80" style="background-color: #f3f3f3;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab1">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <img src="assets/images/others/img-3.jpg" class="img-responsive" alt="Revenue">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <span class="dropcap bg circle">M</span>
                                                    aecenas volutpat, diam enim sagittis quam, id porta quam. Sed id dolor consectetur fermentum volutpat nibh, accumsan purus. Lorem sit ipsum dolor semper consectetur amet, adipiscing elit. In maximus ligula metus pellen tesque mattis. volutpat nibh
                                                </div>
                                                <div class="col-md-6 col-sm-6 mbl-margin-20">
                                                    <h4 style="margin-bottom: 20px;">Feature of Company</h4>
                                                    <ul class="fa-ul">
                                                        <li><i class="fa-li fa fa-check-circle"></i>Interdum malesuada fames</li>
                                                        <li><i class="fa-li fa fa-check-circle"></i>Malesuada fames ante</li>
                                                        <li><i class="fa-li fa fa-check-circle"></i>Nam blandit fermentum</li>
                                                        <li><i class="fa-li fa fa-check-circle"></i>Interdum fames ac ante</li>
                                                        <li><i class="fa-li fa fa-check-circle"></i>Malesuada fames ipsum</li>
                                                        <li><i class="fa-li fa fa-check-circle"></i>Nam at fermentum</li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-12">
                                                    <p style="margin-top: 17px;">Cras ultricies ligula sed magna dictum porta. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Sed porttitor lectus nibh. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <span class="dropcap bg circle">M</span>
                                            aecenas volutpat, diam enim sagittis quam, id porta quam. Sed id dolor consectetur fermentum volutpat nibh, accumsan purus. Lorem ipsum dolor sit semper amet, consectetur adipiscing elit. In maximus ligula metus pellentesque mattis.Praesent sed nisi eleifend, fermentum orci amet, iaculis libero fugiat nulla pariatur. Excepteur .
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <img src="assets/images/others/img-4.jpg" class="img-responsive" alt="Revenue">
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <ul class="fa-ul">
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <img src="assets/images/others/img-5.jpg" class="img-responsive" alt="Revenue">
                                        </div>
                                    </div>
                                </div>
                                <!-- Start Tab Content 4 -->
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <img src="assets/images/others/img-2.jpg" class="img-responsive" alt="Revenue">
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <ul class="fa-ul">
                                                <li><i class="fa-li fa fa-check-circle"></i>Interdum et malesuada fames ac ante</li>
        ...
        {{--<section id="portfolio" class="pad-t80 pad-b50" style="background-color: #fff;">--}}
            {{--<div class="container">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-md-12">--}}
                        {{--<div class="section-title text-center">--}}
                    ...
                    {{--<div class="portfolio-box">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 html">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/1.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 wordpress">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/2.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 joomla">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/3.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 html joomla">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/7.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 joomla wordpress">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/5.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 html wordpress">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/6.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-6 joomla wordpress">--}}
                            {{--<div class="portfolio-post mb30">--}}
                                {{--<img src="assets/images/portfolio/massonry/8.jpg" alt="">--}}
                                {{--<div class="hover-box">--}}
                                    {{--<div class="inner-hover">--}}
                                        {{--<div class="middle">--}}
                                            {{--<div class="portfolio-post-btn">--}}
        ...
        <section class="pad80 parallax" style="background-image: url(assets/images/bg/bg10.jpg); background-position: 50% 30%;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="call-to-action-2 text-center white">
                    ...
                    <div class="col-md-12">
                        <div class="team-section">
                            ...
                            <div class="col-md-12">
                                <div class="team-member-3">
                                    <div class="team-member-img">
                                        <img class="img-responsive" src="assets/images/team/team4.jpg" alt="">
                                    </div>
                                    <div class="team-info">
                                        <span class="team-name">Jon Snow</span>
                                        <span class="team-designation">CEO</span>
        ...
        <!-- Start Blog Section -->
        <section id="blog" class="pad-t80 pad-b50" style="background-color: #f2f2f2;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center">
                    ...
                    <div class="col-md-12">
                        <div class="blog-section">
                            <div class="col-md-12">
                                <div class="latest-news">
                                    <div class="latest-news-img">
                                        ...
                                        <div><span>Aug</span><span>07</span></div>
                                    </div>
                                    <div class="comment">
                            ...
                            <div class="col-md-12">
                                <div class="latest-news">
                                    <div class="latest-news-img">
                                        <img src="assets/images/blog/img-5.jpg" class="img-responsive" alt="blog-post">
                                        <div><span>Aug</span><span>07</span></div>
                                    </div>
                                    <div class="comment">
                                        <p>Posted In: <span>Business, Blog</span></p>
        ...
        <section id="pricing" class="pad-t80 pad-b80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="pricing-box">
                            <div class="pricing-head white" style="background-image: url(assets/images/others/pricing-bg-1.jpg);background-position: 50% 50%;">
                    ...
                    <div class="col-md-4">
                        <div class="pricing-box">
                            <div class="pricing-head white" style="background-image: url(assets/images/others/pricing-bg-2.jpg);background-position: 50% 50%;">
                    ...
                    <div class="col-md-4">
                        <div class="pricing-box">
                            <div class="pricing-head white" style="background-image: url(assets/images/others/pricing-bg-3.jpg);background-position: 50% 50%;">
        ...
        <section id="client" class="pad80 parallax" style="background-image: url(assets/images/bg/bg2.jpg);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-section">
                        <div class="col-md-6 col-xs-12 pull-right black full-height">
                            ...
                            <div class="contact-form">
                                ...
                                <input name="email" id="email" type="text" placeholder="Email" required data-error="Enter valid email address">
                                <div class="help-block with-errors"></div>

                                <input name="msg_subject" id="msg_subject" type="text" placeholder="Subject" data-error="Enter your message subject">
                                <div class="help-block with-errors"></div>

                                <input name="phone" id="phone" type="text" placeholder="Phone" required data-error="Enter your phone number">
                                <div class="help-block with-errors"></div>
        ...
        <section class="footer-section pad-t80 pad-b30" style="background-color: #282828;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="footer-list">
                            <ul>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>HTML5 Resourses</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>CSS3 Resourses</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>PHP Syntax List</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>Wordpress Market</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>Joomla Template</a></li>
                                <li><a href="#"><i class="fa fa-long-arrow-right"></i>JQuery Library</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="copyright">
                        <div class="col-md-12">
                            <div class="copyright-text text-center">
                                <p>AvailSoft © All Rights Reserved. Developed by <a href="#">NelsonEAX</a></p>
                            </div>
                        </div>
                    </div>
                </div>
